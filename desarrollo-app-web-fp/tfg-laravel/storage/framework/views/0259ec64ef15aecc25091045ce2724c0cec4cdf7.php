...
<?php $__env->startSection('content'); ?>
    <div id="areaForm">
        ...
        <div>
            ...
            <div class="ui form" id="formCheck">
                ...
                <div class="field">
                    <div class="ui radio">
                        <label><?php echo app('translator')->getFromJson('captive-portal.form.inhotel'); ?></label>&nbsp;&nbsp;&nbsp;&nbsp;
                        <input class="inhotel" type="radio" name="inhotel" value="0"> <?php echo app('translator')->getFromJson('captive-portal.form.inhotelYes'); ?>&nbsp;&nbsp;&nbsp;
                        <input class="inhotel" type="radio" name="inhotel" value="1"> <?php echo app('translator')->getFromJson('captive-portal.form.inhotelNo'); ?>
                    </div>
                </div>
                <div class="field" id="numRoomdiv">
                    <div class="ui left icon input">
                        <input id="numRoom" type="number" name="numRoom" min="1" max="100">
                        <label><?php echo app('translator')->getFromJson('captive-portal.form.numroom'); ?></label>
                    </div>
                </div>
            </div>
            <div class="ui form" id="selectLogin">
                <div id="optionLoguin" class="text-center">
                    <!--<h2><?php echo app('translator')->getFromJson('captive-portal.form.facebook.tittle'); ?></h2>-->
                    ...
                    <h3><?php echo app('translator')->getFromJson('captive-portal.form.register.o'); ?></h3>
                    <button class="btn btn-primary py-2" id="loginbyform"><i class="fa fa-sign-in-alt" aria-hidden="true"></i> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo app('translator')->getFromJson('captive-portal.form.register.button'); ?></button>
                </div>
            </div>
            <div class="ui form" id="formClient">
                <div id="optionLoguin" class="text-center">
                    <h2><?php echo app('translator')->getFromJson('captive-portal.form.register.tittle'); ?></h2>
                </div>
                <div class="field">
                    <label><?php echo app('translator')->getFromJson('captive-portal.form.name.tittle'); ?></label>
                    <div class="ui left icon input">
                        <i class="user icon"></i>
                        <input id="clientName" type="text" name="name" placeholder="<?php echo app('translator')->getFromJson('captive-portal.form.name.placeholder'); ?>" required>
                    </div>
                </div>
                <div class="field">
                    ...
                    <div class="ui left icon input">
                        ...
                        <input id="clientSurnames" type="text" name="surname" placeholder="<?php echo app('translator')->getFromJson('captive-portal.form.surname.placeholder'); ?>" required>
                    </div>
                </div>
                <div class="field">
                    ...
                    <div class="ui left icon input">
                        ...
                        <input id="clientEmail" type="text" name="email" placeholder="<?php echo app('translator')->getFromJson('captive-portal.form.email.placeholder'); ?>" required>
                    </div>
                </div>
                <div class="field">
                ...
                <div class="field">
                    ...
                    <div class="ui calendar calendarDate left icon input">
                        ...
                        <input id="clientBirthdate" type="text" name="birthdate" placeholder="<?php echo app('translator')->getFromJson('captive-portal.form.birthdate.placeholder'); ?>" required>
                    </div>
                </div>
                <div class="field">
                ...
                <button class="ui primary submit button" success><?php echo app('translator')->getFromJson('captive-portal.form.submit'); ?></button>
    ...
    <script src="<?php echo e(asset('js/fbsdk.js')); ?>" type="text/javascript"></script>
<?php $__env->stopSection(); ?>
